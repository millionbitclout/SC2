...
class StartupAlert(Alert):
  def __init__(self, alert_text_1: str, alert_text_2: str = "To use full openpilot, press LKAS button", alert_status=AlertStatus.normal):
    super().__init__(alert_text_1, alert_text_2,
...
def no_gps_alert(CP: car.CarParams, sm: messaging.SubMaster, metric: bool, soft_disable_time: int) -> Alert:
  ...
  return Alert(
    "Poor GPS reception",
    "If sky is visible, WTF..." if gps_integrated else "Check GPS antenna placement",
    AlertStatus.normal, AlertSize.mid,
...
EVENTS: Dict[int, Dict[str, Union[Alert, AlertCallbackType]]] = {
  ...
  EventName.controlsInitializing: {
    ET.NO_ENTRY: NoEntryAlert("System Booting"),
  },

  EventName.startup: {
    ET.PERMANENT: StartupAlert("WTRU Branch 🙂")
  },
  ...
  EventName.keepHandsOnWheel: {
    ET.IMMEDIATE_DISABLE: ImmediateDisableAlert("Don't take hands off steering wheel"),
  },
  ...
  EventName.fanMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("Fan Malfunction", "WTF"),
  },

  # Camera is not outputting frames at a constant framerate
  EventName.cameraMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("Camera Malfunction", "WTF"),
  },

  # Unused
  EventName.gpsMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("GPS Malfunction", "WTF"),
  },
  ...
  EventName.localizerMalfunction: {
    ET.PERMANENT: NormalPermanentAlert("Sensor Malfunction", "WTF"),
  },
  ...
  EventName.steerTempUnavailable: {
    ET.SOFT_DISABLE: soft_disable_alert("Sharp Turn, Steering Off"),
    ET.NO_ENTRY: NoEntryAlert("Sharp Turn, Steering Off"),
  },
  ...
  EventName.wrongGear: {
    ET.SOFT_DISABLE: user_soft_disable_alert("Set Gear To D or S"),
    ET.NO_ENTRY: NoEntryAlert("Set Gear To D or S"),
  },
  ...
  EventName.seatbeltNotLatched: {
    ...
    ET.NO_ENTRY: NoEntryAlert("Buckle Up"),
  },
