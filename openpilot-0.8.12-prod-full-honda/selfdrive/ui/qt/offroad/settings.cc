...
SunnypilotPanel::SunnypilotPanel(QWidget* parent) : QWidget(parent) {
  ...
  toggles.append(new ParamControl("DisableOnroadUploads",
                                  ...
                                  "Disable uploads completely when onroad. Necessary to avoid high data usage when connected to Wi-Fi hotspot. Leave off if you are looking to utilize map-based features, such as Speed Limit Control and Map Data Turn Control",
                                  "../assets/offroad/icon_network.png",
                                  this));

  toggles.append(new ParamControl("ProcessNotRunningOff",
                                 "Bypass \"System Malfunction\" Error",
                                 "Prevent openpilot from returning the \"System Malfunction\" alert that hinders the ability to use openpilot. Turn on this feature if you experience this alert frequently.",
                                 "../assets/offroad/icon_shell.png",
                                 this));
  ...
  toggles.append(new ParamControl("SpeedLimitControl",
                                  ...
                                  "Use speed limit sign information from map data and car interface to automatically adapt cruise speed to road limits.",
                                  "../assets/offroad/icon_speed_limit.png",
                                  this));
  ...
  toggles.append(new ParamControl("TurnSpeedControl",
                                  "Enable Map Data For Turns",
                                  "Use curvature info from map data to define speed limits to tackle upcoming turns",
                                  "../assets/offroad/icon_openpilot.png",
                                  this));
