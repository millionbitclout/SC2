...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self, TICI=TICI, DT_DMON=DT_DMON):
    ...
    self._MAX_TERMINAL_ALERTS = 4  # not allowed to engage after 4 terminal alerts
    self._MAX_TERMINAL_DURATION = int(10 / self._DT_DMON)  # not allowed to engage after 10s of terminal alerts
